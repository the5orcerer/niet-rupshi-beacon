        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              National Institute of Engineering and Technology - Empowering students with quality education and innovative learning since 2005.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-niet-blue transition-colors">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold font-poppins mb-4">{t("contact.title")}</h4>
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-niet-blue flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">Rupshi, Rupganj, Narayanganj, Bangladesh</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-niet-blue flex-shrink-0" />
                <span className="text-gray-300">+880 1234 567890</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-niet-blue flex-shrink-0" />
